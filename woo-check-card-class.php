 ...
 */
define( 'wc_version_paynext', '1.1.0' );
define( 'woocommerce_plugin_url_paynext', untrailingslashit( plugins_url( basename( plugin_dir_path( __FILE__ ) ), basename( __FILE__ ) ) ) );

class WC_E_CHECK_CARD_paynext {
    ...
    static function e_valid_card_number($toCheck) {
    ...
    static function e_valid_expiry($month, $year) {
        $now = time();
    ...
    static function e_valid_cvv_number($toCheck) {
